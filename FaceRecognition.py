...
# Defining Face Detection Function #

def faceDetection(test_img):

    gray_img = cv2.cvtColor(test_img, cv2.COLOR_BGR2GRAY)
    face_haar = cv2.CascadeClassifier(r"H:\Projects\Face Recognition\haarcascade_frontalface_alt.xml")
...
# Drawing the Rectangle on the FaceFunction #
